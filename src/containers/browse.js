...
export function BrowseContainer({ slides }) {
  ...
  return profile.displayName ? (
    <>
      ...
      <Header src="moneyheist" dontShowOnSmallViewPort>
        <Header.Frame>
          <Header.Group>
            <Header.Logo to={ROUTES.HOME} src={logo} alt="EddieMoon" />
        ...
        <Header.Feature>
          ...
          <Header.Text>
            A criminal mastermind who goes by "The Professor" has a plan to pull off the biggest heist in recorded history -- to print 
